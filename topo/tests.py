...
def testload(net):
    ...
    net.get("c1").sendCmd("python ../nodes/client.py c1-load &")
    net.get("c2").sendCmd("python ../nodes/client.py c2-load &")
    net.get("c3").sendCmd("python ../nodes/client.py c3-load")
...
def testloadbal(net):
    ...
    net.get("c4").sendCmd("python ../nodes/loadBalanceNode.py bal &")

    print("--> Starting load balance and three client - for testing performance")

    net.get("c1").sendCmd("python ../nodes/client.py c1-bal &")
    net.get("c2").sendCmd("python ../nodes/client.py c2-bal &")
    net.get("c3").sendCmd("python ../nodes/client.py c3-bal")
